...
class Homology(object):
	...
	def __init__(self, org, ref, evalue = False, verbose = False):
		...
		self.org_df = pandas.read_csv('blast_files_and_results/org_as_db.txt', sep = '\t', index_col = 0, names = column_names)
		self.ref_df = pandas.read_csv('blast_files_and_results/ref_as_db.txt', sep = '\t', index_col = 0, names = column_names)
